...
arg_lists = []
parser = argparse.ArgumentParser(description='MambaLF')
...
traindata_arg.add_argument('--train_txt', type=str, default='datasets/coco/train2017.txt',
                            help='Train set.')

traindata_arg.add_argument('--train_root', type=str, default='datasets/coco/train2017/',
                            help='Where the train images are.')
traindata_arg.add_argument('--batch_size', type=int, default=4,
...
traindata_arg.add_argument('--pin_memory', type=str2bool, default=True,
                            help='# pin CPU memory, Improve the efficiency of data loading')
...
storage_arg.add_argument('--ckpt_name', type=str, default='mambalf',
                            help='')
